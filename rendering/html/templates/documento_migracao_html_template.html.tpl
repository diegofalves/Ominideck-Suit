...
<head>
    ...
    <title>{{ projeto.nome }} - OmniDeck Documento de Migração</title>
...
<body>
    ...
    <nav class="section-nav">
        ...
        <ul>
            ...
            <li><a href="#sec-metadata">Informações do Projeto</a></li>
            <li><a href="#sec-objetivo">Objetivo de Migração</a></li>
            <li><a href="#sec-historico">Histórico de Alterações</a></li>
            <li><a href="#sec-sumario">Sumário Executivo</a></li>
            <li><a href="#sec-roadmap">Roadmap</a></li>
            <li><a href="#sec-grupos">Grupos de Migração</a></li>
        </ul>
    </nav>
                            ...
                            {% if cache %}
                                ...
                                {% if rows and rows|length > 0 %}
                                    ...
                                    {% else %}
                                        ...
                                        {% endif %}
                                    {% endif %}
                                    <!-- Debug removido: informações técnicas não serão exibidas no PDF -->
